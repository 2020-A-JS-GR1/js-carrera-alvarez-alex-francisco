 ...
 *
 * const informacionCRUD.txt$ = fromFetch('https://api.github.com/users?per_page=5').pipe(
 *  switchMap(response => {
 *    if (response.ok) {
 *      // OK return informacionCRUD.txt
 ...
 * import { fromFetch } from 'rxjs/fetch';
 *
 * const informacionCRUD.txt$ = fromFetch('https://api.github.com/users?per_page=5', {
